...
| **<ul>**                                       | **<ol>**                                                     |
| ---------------------------------------------- | ------------------------------------------------------------ |
| <ul>   <li> 내용 </li>   <li> 내용 </li> </ul> | <ol [속성="속성 값"]>   <li> 내용 </li>   <li> 내용 </li> </ol> |

### 14.  `<ul>`

**: unordered list, 순서가 없는 list**

순서가 없기 때문에 앞에 글자 앞에 *같은 불릿이 붙는다. (css설정으로 없앨 수 있다. ex) list )
...
3)  reversed: 역순으로 할 때  상사용도 

### 15. `<style>`

:  스타일 정보를 정의할때 사용하는 태그

`shead`와 `</head>`사이에 정의한다.
